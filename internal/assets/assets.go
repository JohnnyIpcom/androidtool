...
//go:generate fyne bundle -package assets -o bundled.go -append icon_zeroing.svg
...
// ZeroingIcon is the icon for the zeroing button
var ZeroingIcon = resourceIconzeroingSvg
